function generateStory() {
  ...
  const templates = [
    `Once upon a time, ${keyword} discovered it could talk to bananas.`,
    `In the land of ${keyword}s, everyone wore shoes on their hands and danced backward.`,
    `${keyword} ran for president and won by promising free marshmallows for all.`,
    ...
    `${keyword} opened a bakery that only sold invisible cookies.`,
